...
public class RegisterTest {
    ...
    public void testAdd(int reg1, int reg2, int expected) {
        ...
        InstructionR i = RV32I.instructionR(RV32I.Opcodes.Add, RD, RS1, RS2);
        runner.add(i);
    ...
    public void testSub(int reg1, int reg2, int expected) {
        state.setReg(RS1, reg1);
        state.setReg(RS2, reg2);
        InstructionR i = RV32I.instructionR(RV32I.Opcodes.Sub, RD, RS1, RS2);
        runner.sub(i);
        assertEquals(expected, state.getReg(RD));
    }
    ...
    public void testAnd(int reg1, int reg2, int expected) {
        state.setReg(RS1, reg1);
        state.setReg(RS2, reg2);
        InstructionR i = RV32I.instructionR(RV32I.Opcodes.And, RD, RS1, RS2);
        runner.and(i);
        assertEquals(expected, state.getReg(RD));
    }
    ...
    public void testOr(int reg1, int reg2, int expected) {
        state.setReg(RS1, reg1);
        state.setReg(RS2, reg2);
        InstructionR i = RV32I.instructionR(RV32I.Opcodes.Or, RD, RS1, RS2);
        runner.or(i);
        assertEquals(expected, state.getReg(RD));
    }
    ...
    public void testXor(int reg1, int reg2, int expected) {
        state.setReg(RS1, reg1);
        state.setReg(RS2, reg2);
        InstructionR i = RV32I.instructionR(RV32I.Opcodes.Xor, RD, RS1, RS2);
        runner.xor(i);
        assertEquals(expected, state.getReg(RD));
    }
    ...
    public void testSll(int reg1, int reg2, int expected) {
        state.setReg(RS1, reg1);
        state.setReg(RS2, reg2);
        InstructionR i = RV32I.instructionR(RV32I.Opcodes.Sll, RD, RS1, RS2);
        runner.sll(i);
        assertEquals(expected, state.getReg(RD));
    }
    ...
    public void testSrl(int reg1, int reg2, int expected) {
        state.setReg(RS1, reg1);
        state.setReg(RS2, reg2);
        InstructionR i = RV32I.instructionR(RV32I.Opcodes.Srl, RD, RS1, RS2);
        runner.srl(i);
        assertEquals(expected, state.getReg(RD));
    }
    ...
    public void testSra(int reg1, int reg2, int expected) {
        state.setReg(RS1, reg1);
        state.setReg(RS2, reg2);
        InstructionR i = RV32I.instructionR(RV32I.Opcodes.Sra, RD, RS1, RS2);
        runner.sra(i);
        assertEquals(expected, state.getReg(RD));
    }
    ...
    public void testSlt(int reg1, int reg2, int expected) {
        state.setReg(RS1, reg1);
        state.setReg(RS2, reg2);
        InstructionR i = RV32I.instructionR(RV32I.Opcodes.Slt, RD, RS1, RS2);
        runner.slt(i);
        assertEquals(expected, state.getReg(RD));
    }
    ...
    public void testSltu(int reg1, int reg2, int expected) {
        state.setReg(RS1, reg1);
        state.setReg(RS2, reg2);
        InstructionR i = RV32I.instructionR(RV32I.Opcodes.Sltu, RD, RS1, RS2);
        runner.sltu(i);
        assertEquals(expected, state.getReg(RD));
    }
