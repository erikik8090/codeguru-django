 ...
 * 
 * Each indirect-addressing InstructionInfo has two operands: a register, and one of the
 * above. e.g:
 *               ADD [BX+SI], AX
 * 
 * @author DL
...
public class IndirectAddressingDecoder {
     ...
     * @param memory   Memory. 
     * @param fetcher  Used to fetch additional InstructionInfo bytes.
     */
    ...
    /**
     * Assuming the InstructionInfo operand referred to an 8bit register, returns the
    ...
    /**
     * Assuming the InstructionInfo operand referred to a 16bit register, returns the
     * corresponding register's value.
    ...
    /**
     * Assuming the InstructionInfo operand referred to a segment register, returns the
     * corresponding register's value.
    ...
    /**
     * Assuming the InstructionInfo operand referred to an 8bit register, sets the
     * corresponding register's value.
    ...
    /**
     * Assuming the InstructionInfo operand referred to a 16bit register, sets the
     * corresponding register's value.
    ...
    /**
     * Assuming the InstructionInfo operand referred to a segment register, sets the
     * corresponding register's value.
     * @param value    New value for the segment register.
     */
    ...
    /** Used to fetch additional InstructionInfo bytes. */
    private final OpcodeFetcher m_fetcher;

    /** Used to decode the non-memory part of the InstructionInfo */
