...
public class InstructionS extends InstructionBase
{
    public InstructionS(int raw)
    {
        super(raw);
    }

    public InstructionS(InstructionBase i)
    {
        super(i.raw);
    }

    public InstructionS(int opcode, int funct3, int rs1, int rs2, int imm)
    {
        super(
                (opcode & mask(7)) |
                        ((imm & mask(5)) << 7) |
