...
public abstract class Disassembler
{
	 ...
	 * @throws DisassemblerException 
	 */
	public short nextWord() throws DisassemblerException
	{
		byte low = nextByte();
		byte high = nextByte();
	 ...
	 * @throws DisassemblerException 
	 */
	private void resetIndirect() throws DisassemblerException //
	{
	 ...
	 * @throws DisassemblerException 
	 */
	private String getMem16() throws DisassemblerException
	{
		if (mode == 3)
	 ...
	 */
	private String getReg8(byte index)
	{
		switch (index)
		{
	        case 0:
	 ...
	 */
	private String getReg16(byte index)
	{
		switch (index)
		{
	        case 0:
	 ...
	 */
	private String getSeg(byte index)
	{
        switch (index)
        {
            case 0:
	...
	private short toWord(byte b1, byte b2)
	{
	...
	public String toString(short segment, short offset)
	{
    ...
    private String opcode0X(byte opcode) throws DisassemblerException{
        switch (opcode) {
    ...
    private String opcode1X(byte opcode) throws DisassemblerException{
        switch (opcode) {
    ...
    private String opcode2X(byte opcode) throws DisassemblerException{
        switch (opcode) {			
    ...
    private String opcode3X(byte opcode) throws DisassemblerException {
        switch (opcode) {			
    ...
    private String opcode4X(byte opcode) {
    ...
    private String opcode5X(byte opcode) {
        byte index = (byte)(opcode & 0x07);
        switch (opcode) {
    ...
    private String opcode6X(byte opcode) throws DisassemblerException {
        // 0x60.. 0x6F - invalid opcodes
    	throw new DisassemblerException();	
    }

    private String opcode7X(byte opcode) throws DisassemblerException {
        String jump = "";
        switch(opcode) {
            case (byte)0x70: // JO
            	jump = "JO";
    ...
    private String opcodeAX(byte opcode) throws DisassemblerException {
        switch (opcode) {
    ...
    private String opcodeBX(byte opcode) throws DisassemblerException {
        byte index = (byte)(opcode & 0x07);
        switch (opcode) {
    ...
    private String opcodeCX(byte opcode) throws DisassemblerException {
        switch (opcode) {
            case (byte)0xC0:
            case (byte)0xC1:
    ...
    private String opcodeDX(byte opcode) throws DisassemblerException {
        switch (opcode) {
